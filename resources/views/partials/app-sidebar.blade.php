            ...
            <ul class="vertical-nav-menu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="createprograms.html">
                                <i class="metismenu-icon pe-7s-loop">
                                </i>Create Programs
                            </a>
                        </li>
                        <li>
                            <a href="programslist.html">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="divisionwise.html">
                                <i class="metismenu-icon">
                                </i>Division Wise
                            </a>
                        </li>
                        <li>
                            <a href="programwise.html">
                                <i class="metismenu-icon">
                                </i>Program Wise
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="mastergraph.html">
                                <i class="metismenu-icon">
                                </i>Master Graph
                            </a>
                        </li>
                        <li>
                            <a href="attendace.html">
                                <i class="metismenu-icon">
                                </i>Attendance
                            </a>
                        </li>
